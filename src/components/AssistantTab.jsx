...
export default function AssistantTab() {
  ...
  async function send(text = input) {
    ...
    try {
      ...
      setMessages((m) => [...m, { role: 'assistant', content: data.text || 'Hazır.' }]); setAction(data.action || null); setEngine('openai');
    } catch {
